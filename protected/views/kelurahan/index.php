...
$this->pageTitle = Yii::app()->params['title'] . ' - ' . Yii::t('trans', 'Manage') . ' ' . Yii::t('trans', 'Kelurahan');
$this->modulTitle = Yii::t('trans', 'Manage') . ' ' . Yii::t('trans', 'Kelurahan');
$this->menu = array(
...
<div class="grid-view pull-right">
    <div class="filter-container">
        ...
        echo Yii::t('trans', 'Tampil') . ' : ' . CHtml::dropDownList('pageSizeTop', $pageSize, Yii::app()->params['optionsPage'], array(
            'onchange' => '$.fn.yiiGridView.update(\'kelurahan-grid\',{ data:{pageSize: $(this).val() }})',
            'style' => 'width:70px;'
        ));
        ?>            </div>
</div>
<?php
$visible_update = (Yii::app()->util->is_authorized('kelurahan.update')) ? 'true' : 'false';
$visible_delete = (Yii::app()->util->is_authorized('kelurahan.delete')) ? 'true' : 'false';
