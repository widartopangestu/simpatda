...
$this->pageTitle = Yii::app()->params['title'] . ' - ' . Yii::t('trans', 'Manage') . ' ' . Yii::t('trans', 'Golongan');
$this->modulTitle = Yii::t('trans', 'Manage') . ' ' . Yii::t('trans', 'Golongan');
$this->menu = array(
...
<div class="grid-view pull-right">
    <div class="filter-container">
        ...
        echo Yii::t('trans', 'Tampil') . ' : ' . CHtml::dropDownList('pageSizeTop', $pageSize, Yii::app()->params['optionsPage'], array(
            'onchange' => '$.fn.yiiGridView.update(\'golongan-grid\',{ data:{pageSize: $(this).val() }})',
            'style' => 'width:70px;'
        ));
        ?>            </div>
</div>
<?php
$visible_update = (Yii::app()->util->is_authorized('golongan.update')) ? 'true' : 'false';
$visible_delete = (Yii::app()->util->is_authorized('golongan.delete')) ? 'true' : 'false';
