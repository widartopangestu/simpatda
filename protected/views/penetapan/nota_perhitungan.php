...
$this->breadcrumbs = array(
    ...
    Yii::t('trans', 'Cetak Nota Perhitungan'),
);
$this->pageTitle = Yii::app()->params['title'] . ' - ' . Yii::t('trans', 'Cetak Nota Perhitungan');
$this->modulTitle = Yii::t('trans', 'Cetak Nota Perhitungan');
?>
<div class="form">
    <?php
