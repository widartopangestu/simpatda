...
//                                        array('label' => Yii::t('trans', 'Cetak Daftar BPHTB') . ' -BELOM-', 'visible' => Yii::app()->util->is_authorized('jReport.setoranPajak'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/penetapan/cetakPenetapan')),
                                        TbHtml::menuDivider(),
                                        array('label' => Yii::t('trans', 'Laporan Bulanan - Galian Gol C') . ' -BELOM-', 'visible' => Yii::app()->util->is_authorized('jReport.setoranPajak'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/penetapan/cetakPenetapan')),
                                        array('label' => Yii::t('trans', 'Rekapitulasi Penggunaan - Galian Gol C') . ' -BELOM-', 'visible' => Yii::app()->util->is_authorized('jReport.setoranPajak'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/penetapan/cetakPenetapan')),
                                        array('label' => Yii::t('trans', 'Produksi Dan Penerimaan Daerah - Galian Gol C') . ' -BELOM-', 'visible' => Yii::app()->util->is_authorized('jReport.setoranPajak'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/penetapan/cetakPenetapan')),
                                        TbHtml::menuDivider(),
