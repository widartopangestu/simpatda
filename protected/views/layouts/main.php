                        ...
                        $this->widget('bootstrap.widgets.TbNav', array(
                            'items' => array(
                                ...
                                array('label' => '<span>' . Yii::t('trans', 'BKP') . '</span>', 'visible' => !Yii::app()->user->isGuest, 'url' => '#', 'items' => array(
                                        ...
                                        TbHtml::menuDivider(),
                                        array('label' => Yii::t('trans', 'Cetak Buku Pembantu Penerimaan Sejenis (BPPS)') . ' -BELOM-', 'visible' => Yii::app()->util->is_authorized('jReport.setoranPajak'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/penetapan/cetakPenetapan')),
                                        array('label' => Yii::t('trans', 'Cetak Buku Pembantu Penerimaan Sejenis (BPPS) Detal') . ' -BELOM-', 'visible' => Yii::app()->util->is_authorized('jReport.setoranPajak'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/penetapan/cetakPenetapan')),
                                ...
                                array('label' => '<span>' . Yii::t('trans', 'Pembukuan Pelaporan') . '</span>', 'visible' => !Yii::app()->user->isGuest, 'url' => '#', 'items' => array(
                                        ...
                                        array('label' => Yii::t('trans', 'Pajak Reklame') . ' -BELOM-', 'visible' => Yii::app()->util->is_authorized('jReport.setoranPajak'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/penetapan/cetakPenetapan')),
                                        array('label' => Yii::t('trans', 'Rekapitulasi Pajak Walet') . ' -BELOM-', 'visible' => Yii::app()->util->is_authorized('jReport.setoranPajak'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/penetapan/cetakPenetapan')),
                                        ...
                                        array('label' => Yii::t('trans', 'Rekapitulasi PenggunaanGalian Gol C') . ' -BELOM-', 'visible' => Yii::app()->util->is_authorized('jReport.setoranPajak'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/penetapan/cetakPenetapan')),
