                        ...
                        $this->widget('bootstrap.widgets.TbNav', array(
                            'items' => array(
                                ...
                                array('label' => '<span>' . Yii::t('trans', 'Penetapan') . '</span>', 'visible' => !Yii::app()->user->isGuest, 'url' => '#', 'items' => array(
                                        ...
                                        array('label' => Yii::t('trans', 'Cetak Surat Ketetapan') . ' -BELOM-', 'visible' => Yii::app()->util->is_authorized('penetapan.cetakPenetapan'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/penetapan/cetakPenetapan')),
                                    )
                                ),
                                array('label' => '<span>' . Yii::t('trans', 'BKP') . '</span>', 'visible' => !Yii::app()->user->isGuest, 'url' => '#', 'items' => array(
                                        ...
                                        TbHtml::menuDivider(),
                                        array('label' => Yii::t('trans', 'Cetak Buku Pembantu Penerimaan Sejenis (BPPS)'), 'visible' => Yii::app()->util->is_authorized('jReport.bpps'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/jReport/bpps')),
                                        array('label' => Yii::t('trans', 'Cetak Buku Pembantu Penerimaan Sejenis (BPPS) Detail'), 'visible' => Yii::app()->util->is_authorized('jReport.bppsDetail'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/jReport/bppsDetail')),
                                        ...
                                        array('label' => Yii::t('trans', 'Rekap Bulanan') . ' -BELOM-', 'visible' => Yii::app()->util->is_authorized('jReport.setoranPajak'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/penetapan/cetakPenetapan')),
                                        array('label' => Yii::t('trans', 'Rekap Bulanan Fungsional') . ' -BELOM-', 'visible' => Yii::app()->util->is_authorized('jReport.setoranPajak'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/penetapan/cetakPenetapan')),
                                    )
                                ),
                                array('label' => '<span>' . Yii::t('trans', 'Pembukuan Pelaporan') . '</span>', 'visible' => !Yii::app()->user->isGuest, 'url' => '#', 'items' => array(
//                                        array('label' => Yii::t('trans', 'Data Setoran Pajak Catering') . ' -BELOM-', 'visible' => Yii::app()->util->is_authorized('jReport.setoranPajak'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/penetapan/cetakPenetapan')),
                                        array('label' => Yii::t('trans', 'Pajak Reklame'), 'visible' => Yii::app()->util->is_authorized('jReport.bpsReklame'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/jReport/bpsReklame')),
                                        array('label' => Yii::t('trans', 'Rekapitulasi Pajak Walet'), 'visible' => Yii::app()->util->is_authorized('jReport.bpsWalet'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/jReport/bpsWalet')),
//                                        array('label' => Yii::t('trans', 'Cetak Daftar BPHTB') . ' -BELOM-', 'visible' => Yii::app()->util->is_authorized('jReport.setoranPajak'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/penetapan/cetakPenetapan')),
                                        TbHtml::menuDivider(),
                                        array('label' => Yii::t('trans', 'Laporan Bulanan - Galian Gol C'), 'visible' => Yii::app()->util->is_authorized('jReport.bulananGalian'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/jReport/bulananGalian')),
                                        array('label' => Yii::t('trans', 'Rekapitulasi Penggunaan - Galian Gol C'), 'visible' => Yii::app()->util->is_authorized('jReport.penggunaanGalian'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/jReport/penggunaanGalian')),
                                        array('label' => Yii::t('trans', 'Produksi Dan Penerimaan Daerah - Galian Gol C'), 'visible' => Yii::app()->util->is_authorized('jReport.produksiGalian'), 'icon' => TbHtml::ICON_LIST, 'url' => array('/jReport/produksiGalian')),
                                        TbHtml::menuDivider(),
