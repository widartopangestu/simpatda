<?php
$this->pageTitle = Yii::app()->params['title'] . ' - ' . Yii::t('trans', 'Help');
$this->modulTitle = Yii::t('trans', 'Help');
$this->breadcrumbs = array(
    Yii::t('trans', 'Help')
);
?>
<link href="<?php echo Yii::app()->request->baseUrl; ?>/css/pages/faq.css" rel="stylesheet"> 
...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/faq.js"></script>
