...
$this->pageTitle = Yii::app()->params['title'] . ' - ' . Yii::t('trans', 'Manage') . ' ' . Yii::t('trans', 'Reklame Ketinggian');
$this->modulTitle = Yii::t('trans', 'Manage') . ' ' . Yii::t('trans', 'Reklame Ketinggian');
$this->menu = array(
...
<div class="grid-view pull-right">
    <div class="filter-container">
        ...
        echo Yii::t('trans', 'Tampil') . ' : ' . CHtml::dropDownList('pageSizeTop', $pageSize, Yii::app()->params['optionsPage'], array(
            'onchange' => '$.fn.yiiGridView.update(\'reklame-ketinggian-grid\',{ data:{pageSize: $(this).val() }})',
            'style' => 'width:70px;'
        ));
        ?>    </div>
</div>
<?php
$visible_view = (Yii::app()->util->is_authorized('reklameKetinggian.view')) ? 'true' : 'false';
$visible_update = (Yii::app()->util->is_authorized('reklameKetinggian.update')) ? 'true' : 'false';
$visible_delete = (Yii::app()->util->is_authorized('reklameKetinggian.delete')) ? 'true' : 'false';
$this->widget('yiiwheels.widgets.grid.WhGridView', array(
    'id' => 'reklame-ketinggian-grid',
