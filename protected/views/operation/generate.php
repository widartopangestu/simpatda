...
$this->pageTitle = Yii::app()->params['title'] . ' - ' . Yii::t('trans', 'Generate') . ' ' . Yii::t('trans', 'Operations');
$this->breadcrumbs = array(
    Yii::t('trans', 'Operations') => array('admin'),
    Yii::t('trans', 'Generate'),
);
$this->modulTitle = Yii::t('trans', 'Generate') . ' ' . Yii::t('trans', 'Operations');
$this->menu = array(
