...
$this->breadcrumbs = array(
    Yii::t('trans', 'Cetak Rekapitulasi Penerimaan') . ' ' . $model->kodeRekeningText,
);
$this->pageTitle = Yii::app()->params['title'] . ' - ' . Yii::t('trans', 'Cetak Rekapitulasi Penerimaan') . ' ' . $model->kodeRekeningText;
$this->modulTitle = Yii::t('trans', 'Cetak Rekapitulasi Penerimaan') . ' ' . $model->kodeRekeningText;
?>
<div class="form">
    <?php
