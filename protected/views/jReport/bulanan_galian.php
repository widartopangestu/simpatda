...
$this->breadcrumbs = array(
    ...
    Yii::t('trans', 'Laporan Bulanan Pajak Galian'),
);
$this->pageTitle = Yii::app()->params['title'] . ' - ' . Yii::t('trans', 'Laporan Bulanan Pajak Galian');
$this->modulTitle = Yii::t('trans', 'Laporan') . ' ' . Yii::t('trans', 'Laporan Bulanan Pajak Galian');
?>
<div class="form">
    <?php
