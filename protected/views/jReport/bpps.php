...
$this->breadcrumbs = array(
    ...
    Yii::t('trans', 'Buku Pembantu Penerimaan Sejenis (BPPS)'),
);
$this->pageTitle = Yii::app()->params['title'] . ' - ' . Yii::t('trans', 'Buku Pembantu Penerimaan Sejenis (BPPS)');
$this->modulTitle = Yii::t('trans', 'Laporan') . ' ' . Yii::t('trans', 'Buku Pembantu Penerimaan Sejenis (BPPS)');
?>
<div class="form">
    <?php
