...
$this->breadcrumbs = array(
    ...
    Yii::t('trans', 'Buku Pembantu Penerimaan Sejenis (BPPS) Detail'),
);
$this->pageTitle = Yii::app()->params['title'] . ' - ' . Yii::t('trans', 'Buku Pembantu Penerimaan Sejenis (BPPS) Detail');
$this->modulTitle = Yii::t('trans', 'Laporan') . ' ' . Yii::t('trans', 'Buku Pembantu Penerimaan Sejenis (BPPS) Detail');
?>
<div class="form">
    <?php
    ...
    <?php echo $form->dropdownListControlGroup($model, 'via_bayar', $model->viaBayarOptions, array('span' => 5)); ?>
    <?php echo $form->dropdownListControlGroup($model, 'mengetahui', $model->pejabatOptions, array('span' => 5)); ?>
    <?php echo $form->dropdownListControlGroup($model, 'bendahara', $model->pejabatOptions, array('span' => 5)); ?>
