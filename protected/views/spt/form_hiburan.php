                ...
                <table class="table table-striped table-bordered items-list">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo Yii::t('trans', 'Persen Tarip (%)'); ?><br/>(b)</th>
                    ...
                    <tbody>
                        <?php if ($model->isNewRecord): ?>
                            <tr class="template" style="display: none;">
                                ...
                                <td><input name="items[x][dasar_pengenaan]" id="items_xxdasar_pengenaan" class="span3 required" type="text" onkeyup="getValueHiburan();" style="text-align: right;"></td>
                                ...
                                <td style="text-align: center;"><a href="#" class="btn btn-primary remove-items"><?php echo Yii::t('trans', 'Delete'); ?></a></td>
                            </tr>
                        <?php else : ?>         
                            <tr class="template" style="display: none;">
                                <td>
                            ...
                            foreach ($model->sptItems as $item):
                                ...
                                <tr class="new">
                                    ...
                                    <td><input value="<?php echo $item->nilai; ?>" name="items[<?php echo $index; ?>][dasar_pengenaan]" id="items_<?php echo $index; ?>xdasar_pengenaan" class="span3 required" type="text" onkeyup="getValueHiburan();" style="text-align: right;"></td>
                                    ...
                                    <td style="text-align: center;"><a href="#" class="btn btn-primary remove-items" id="<?php echo $item->id; ?>"><?php echo Yii::t('trans', 'Delete'); ?></a></td>
                                </tr>
                                <?php
                                $index++;
                            endforeach;
