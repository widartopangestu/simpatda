...
$this->breadcrumbs = array(
    Yii::t('trans', 'SPTPD') => array('index', 'jenis' => Spt::JENIS_PAJAK_REKLAME),
    Yii::t('trans', 'Create') . ' ' . Yii::t('trans', 'SPTPD Pajak Reklame'),
);
$this->pageTitle = Yii::app()->params['title'] . ' - ' . Yii::t('trans', 'Create') . ' ' . Yii::t('trans', 'SPTPD Pajak Reklame');
$this->modulTitle = Yii::t('trans', 'Create') . ' ' . Yii::t('trans', 'SPTPD Pajak Reklame');
$this->menu = array(
    array('label' => Yii::t('trans', 'Manage'), 'url' => array('index', 'jenis' => Spt::JENIS_PAJAK_REKLAME), 'icon' => 'list-alt', 'visible' => (Yii::app()->util->is_authorized('spt.index')) ? true : false),
);
?>
<div class="form">
    ...
    <div class="row">
        ...
        <div class="span5">
            ...
            <?php echo $form->dropdownListControlGroup($model, 'kode_rekening_id', KodeRekening::model()->getParentTreeOptions(Spt::PARENT_REKLAME), array('span' => 3, 'empty' => Yii::t('trans', '-- Pilih Kode Rekening --'), 'onchange' => 'getNamaRekening($(this).val())')); ?>
...
<script type="text/javascript">
    ...
    function getValueReklame() {
        jQuery.ajax({'type': 'POST', 'url': '<?php echo $this->createUrl('spt/ajaxGetValueReklame'); ?>', 'cache': false, dataType: 'json', 'data': $('#spt-form').serialize()}).done(function (data) {
