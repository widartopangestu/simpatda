...
class KecamatanController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Kecamatan'])) {
            ...
            if ($model->save()) {
                Yii::app()->util->setLog(AccessLog::TYPE_SUCCESS, Yii::t('trans', 'Create Kecamatan ID : ') . $model->primaryKey);
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['Kecamatan'])) {
            $model->attributes = $_POST['Kecamatan'];
            if ($model->save()) {
                Yii::app()->util->setLog(AccessLog::TYPE_SUCCESS, Yii::t('trans', 'Update Kecamatan ID : ') . $model->id);
                $this->redirect(array('index'));
            }
        }
    ...
    public function actionIndex() {
        ...
        Yii::app()->util->setLog(AccessLog::TYPE_INFO, Yii::t('trans', 'Manage Kecamatan'));
