...
/**
 * This is the model class for table "reklame_lokasi".
 *
 * The followings are the available columns in table 'reklame_lokasi':
 * @property integer $id
 ...
 */
class ReklameLokasi extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'reklame_lokasi';
    }
     ...
     * @return ReklameLokasi the static model class
     */
