...
class Role extends CActiveRecord {
    ...
    public function getOperationOptions() {
        return CHtml::listData(Operation::model()->findAll(), 'id', 'description');
    }

    public function getOperationsFormat() {
        $data = '<ul>' . PHP_EOL;
        foreach ($this->operations as $operation)
            $data .= '<li>' . $operation->description . '</li>' . PHP_EOL;
        $data .= '</ul>' . PHP_EOL;
        return $data;
    }
    ...
    public function getChecked($operation_id) {
        $check = RoleAccess::model()->countByAttributes(array('role_id'=>  $this->id,'operation_id'=>$operation_id));
