...
/**
 * This is the model class for table "setoran_bank".
 *
 * The followings are the available columns in table 'setoran_bank':
 * @property integer $id
 ...
 */
class SetoranBank extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, tanggal, nomor, created, updated', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'setoranBankItems' => array(self::HAS_MANY, 'SetoranBankItem', 'setoran_bank_id'),
        );
    }
     ...
     * @return SetoranBank the static model class
     */
