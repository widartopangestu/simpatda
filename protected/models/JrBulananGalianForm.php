...
/**
 * JrBulananGalianForm class.
 * JrBulananGalianForm is the data structure for keeping
 */
class JrBulananGalianForm extends CFormModel {
    ...
    public function rules() {
        return array(
            array('mengetahui, pembuat, periode, bulan', 'required'),
