...
/**
 * SuratKetetapanForm class.
 * SuratKetetapanForm is the data structure for keeping
 */
class SuratKetetapanForm extends CFormModel {
    ...
    public function rules() {
        return array(
            array('tanggal, date_from, date_to, menyetujui, mengetahui, diperiksa, sort_by', 'required'),
            array('jenis_pajak, jenis_surat_id, mengetahui, menyetujui, diperiksa, kecamatan_id, sort_by', 'safe'),
    ...
    public function attributeLabels() {
        return array(
            ...
            'jenis_surat_id' => Yii::t('trans', 'Pilihan Ketetapan'),
            'sort_by' => Yii::t('trans', 'Laporan Berdasarkan'),
        );
    }
    ...
    public function getKodeRekeningText() {
        ...
        $nama = '';
        if ($model !== null) {
            $nama = $model->nama . ' (' . $model->kode . ')';
        }
        return $nama;
    }

    public function getJenisSuratText() {
        $model = JenisSurat::model()->findByPk($this->jenis_surat_id);
        $nama = '';
        if ($model !== null) {
            $nama = $model->nama;
        }
    ...
    public function getSortByOptions() {
        return array(
            'tanggal_penetapan' => Yii::t('trans', 'Tanggal Ketetapan'),
            'tanggal_bayar' => Yii::t('trans', 'Tanggal Setor')
        );
    }
