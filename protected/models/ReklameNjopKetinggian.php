...
/**
 * This is the model class for table "reklame_njop_ketinggian".
 *
 * The followings are the available columns in table 'reklame_njop_ketinggian':
 * @property integer $id
 ...
 */
class ReklameNjopKetinggian extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'reklame_njop_ketinggian';
    }
     ...
     * @return ReklameNjopKetinggian the static model class
     */
