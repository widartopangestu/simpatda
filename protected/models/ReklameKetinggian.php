...
/**
 * This is the model class for table "reklame_ketinggian".
 *
 * The followings are the available columns in table 'reklame_ketinggian':
 * @property integer $id
 ...
 */
class ReklameKetinggian extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'reklame_ketinggian';
    }
     ...
     * @return ReklameKetinggian the static model class
     */
