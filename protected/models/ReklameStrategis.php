...
/**
 * This is the model class for table "reklame_strategis".
 *
 * The followings are the available columns in table 'reklame_strategis':
 * @property integer $id
 ...
 */
class ReklameStrategis extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'reklame_strategis';
    }
     ...
     * @return ReklameStrategis the static model class
     */
